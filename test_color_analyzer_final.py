...
def test_color_analyzer_initialization():
    ...
    try:
        ...
        if hasattr(analyzer, 'color_databases'):
            ...
            print("X No color_databases attribute found")
            return False
            
    except Exception as e:
        print(f"X Error creating ColorAnalyzer: {e}")
        traceback.print_exc()
        return False
    ...
    try:
        ...
        for r, g, b, description in test_colors:
            try:
                ...
                print(f"X Error matching {description}: {e}")
                return False
        ...
        print(f"X Error in color matching test: {e}")
        traceback.print_exc()
        return False
...
def test_hsv_conversion():
    ...
    try:
        ...
        print(f"X Error in HSV conversion test: {e}")
        traceback.print_exc()
        return False
...
def test_cmyk_conversion():
    ...
    try:
        ...
        print(f"X Error in CMYK conversion test: {e}")
        traceback.print_exc()
        return False
...
def test_color_analysis_comprehensive():
    ...
    try:
        ...
        print(f"X Error in comprehensive analysis test: {e}")
        traceback.print_exc()
        return False
...
def test_external_dictionaries():
    ...
    try:
        ...
        if len(loaded_dbs) >= 2:  # At least CSS3 and X11 should load (fallbacks)
            ...
            print("X Insufficient databases loaded")
            return False
        
    except Exception as e:
        print(f"X Error in dictionary loading test: {e}")
        traceback.print_exc()
        return False
